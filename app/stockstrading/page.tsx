...
import StockBanner from "@/public/img/Hero4.jpg";
...
const StocksTrading = () => {
  ...
  return (
    <>
      ...
      <Banner
        text="Stocks Trading"
        smallText="Stocks for Your Portfolio"
        image={StockBanner}
      />
      <div className="__section" ref={refHandle}>
        <div className="container">
          <div className="content">
            ...
            <p>
              <b>How Do I Trade Stocks?</b>
              <br />A stock market is where stocks are traded: where sellers and
            ...
            <p>
              <b>Stock Trading Risk Assessment</b>
              <br />
